...
export class BaseComponent<objType> implements OnInit {
   ...
   */
  public paginate(objArray:Array<objType>, page:number, numberOfRecords: number) : Array<objType>{
   ...
   */
  public sortData(objArray:Array<any>, sortOrder:boolean, key = 'id'): Array<objType>{
   ...
   */
  public searchData(objArray:Array<any>, searchValue: string): Array<objType>{
   ...
   */
  public deleteData(objArray:Array<objType>, obj: any): Array<objType>{
